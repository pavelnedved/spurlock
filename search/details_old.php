...
<head>
    ...
    <link href="http://www.spurlock.illinois.edu/support/CSS/Design.css" rel="stylesheet" type="text/css"
          media="screen">
    ...
    <!-- InstanceParam name="containerstyle" type="text" value="background-color:#FFFFFF" -->
    <!-- InstanceParam name="collectionsCurrent" type="text" value="CURRENT" -->
    <!-- InstanceParam name="artmonCurrent" type="text" value="" -->
    <!-- InstanceParam name="newacqCurrent" type="text" value="" -->
    <!-- InstanceParam name="collhighCurrent" type="text" value="" -->
    <!-- InstanceParam name="searchCurrent" type="text" value="CURRENT" -->
    <!-- InstanceParam name="exhibitsCurrent" type="text" value="" -->
    <!-- InstanceParam name="exhibinfoCurrent" type="text" value="" -->
    <!-- InstanceParam name="featurehighCurrent" type="text" value="" -->
    <!-- InstanceParam name="vtourCurrent" type="text" value="" -->
    <!-- InstanceParam name="prevexhibitsCurrent" type="text" value="" -->
    <!-- InstanceParam name="educationCurrent" type="text" value="" -->
    <!-- InstanceParam name="calenderCurrent" type="text" value="" -->
    <!-- InstanceParam name="inhouseCurrent" type="text" value="" -->
    <!-- InstanceParam name="outreachCurrent" type="text" value="" -->
    <!-- InstanceParam name="reservingCurrent" type="text" value="" -->
    <!-- InstanceParam name="informationCurrent" type="text" value="" -->
    <!-- InstanceParam name="newsCurrent" type="text" value="" -->
    <!-- InstanceParam name="explorationsCurrent" type="text" value="" -->
    <!-- InstanceParam name="policiesCurrent" type="text" value="" -->
    <!-- InstanceParam name="historyCurrent" type="text" value="" -->
    <!-- InstanceParam name="employCurrent" type="text" value="" -->
    <!-- InstanceParam name="onresWhyCurrent" type="text" value="" -->
    <!-- InstanceParam name="onresPngCurrent" type="text" value="" -->
    <!-- InstanceParam name="onresCurrent" type="text" value="" -->
    <!-- InstanceParam name="TPCurrent" type="text" value="NOLINK" -->
    <!-- InstanceParam name="exhistoryCurrent" type="text" value="" -->
    <!-- InstanceParam name="exmovingCurrent" type="text" value="" -->
    <!-- InstanceParam name="randArt_EnableRotation" type="text" value="true" -->
    <!-- InstanceParam name="randArt_ImageFolder" type="text" value="/elements/random/" -->
</head>
...
<div id="SMheaderbase">
    <div id="SMheaderimark">
        <a href="http://illinois.edu"><img
                src="http://www.spurlock.illinois.edu/support/elements/header/images/imark.gif" alt="I mark logo"
                width="38" height="50" class="noborder"></a>
    </div>
    <div id="SMrotating">
        <a href="http://spurlock.illinois.edu/search/details.php?a=1900.18.0001"><img
                src="http://spurlock.illinois.edu/elements/random/1900.18.0001.jpg" alt="random artifact" width="320"
                height="109"></a>
    </div>
    <div id="SMheadertitle">
        <a href="http://spurlock.illinois.edu/"><img
                src="http://www.spurlock.illinois.edu/support/elements/header/images/smtitle.png"
                alt="The William R. and Clarice V. Spurlock Museum at University of Illinois at Urbana-Champaign"
                width="441" height="74"></a>
    </div>
</div>
        ...
        <ul id="Menu1" class="MM">
            ...
            <li><a class="" href="http://www.spurlock.illinois.edu/info/index.html">INFORMATION</a>
                <ul>
                    ...
                    <li><a class="" href="http://www.spurlock.illinois.edu/info/employment.html">Employment &amp;
            ...
            <li><a class="" href="http://www.spurlock.illinois.edu/explorations/index.html">EXPLORATIONS</a>
                <ul>
                    <li><a class="" href="http://www.spurlock.illinois.edu/explorations/online/index.html">Online
                            Resources</a>
                        <ul>
                            <li>
                                <a href="http://www.spurlock.illinois.edu/explorations/online/MandarinSquares/index.html">Chinese
                                    Mandarin Squares</a></li>
                            <li><a href="http://www.spurlock.illinois.edu/explorations/online/mummification/index.html">Egyptian
                                    Mummification</a></li>
                            <li><a href="http://www.spurlock.illinois.edu/explorations/online/bali/index.html">Journeying
                                    Through Balinese Lives</a></li>
                            <li><a href="http://www.spurlock.illinois.edu/explorations/online/senufomusic/index.html">Musical
                                    Expressions of the Senufo-Tagba</a></li>
                            <li><a href="http://www.spurlock.illinois.edu/explorations/online/senufo/index.html">Senufo
                                    Tagba of West Africa</a></li>
                            <li><a class=""
                                   href="http://www.spurlock.illinois.edu/explorations/online/papua/index.html">The
                                    Transforming Arts of Papua New Guinea</a></li>
                            <li><a class=""
                                   href="http://www.spurlock.illinois.edu/explorations/online/whyknot/index.html">Why
                                    Knot?</a></li>
                        </ul>
                    </li>
                    <li><a class="" href="http://www.spurlock.illinois.edu/explorations/history/index.html">Spurlock
                            History</a>
                        <ul>
                            <li><a class=""
                                   href="http://www.spurlock.illinois.edu/explorations/history/history/index.html">History
                                    of the Museum</a></li>
                            <li><a class=""
                                   href="http://www.spurlock.illinois.edu/explorations/history/moving/index.html">Moving
                                    the Museum</a></li>
                        </ul>
                    </li>
            ...
            <li><a class="CURRENT" href="http://www.spurlock.illinois.edu/collections/index.html">COLLECTIONS</a>
                <ul>
                    <li><a class="" href="http://www.spurlock.illinois.edu/collections/artifact/index.html">Featured
                            Artifact</a></li>
                    <li><a class="" href="http://www.spurlock.illinois.edu/collections/new/index.html">New
                            Acquisitions</a></li>
                    <li><a class="" href="http://www.spurlock.illinois.edu/collections/browse/index.html">Collection
                            Highlights</a></li>
                    <li><a class="CURRENT" href="http://www.spurlock.illinois.edu/search/index.php">Search
                            Collections</a></li>
                </ul>
            </li>
            <li><a class="" href="http://www.spurlock.illinois.edu/exhibits/index.html">EXHIBITS</a>
                <ul>
                    <li><a class="" href="http://www.spurlock.illinois.edu/exhibits/index.html">General Exhibits
                            Information</a></li>
                    <li><a class="" href="http://www.spurlock.illinois.edu/exhibits/highlights/index.html">Feature
                            Gallery Highlights </a></li>
                    <li><a class="" href="http://www.spurlock.illinois.edu/exhibits/vtour/index.html">Virtual Tour of
                            the Feature Galleries</a></li>
                    <li><a class="" href="http://www.spurlock.illinois.edu/exhibits/previous.html">Previous Exhibits</a>
                    </li>
                </ul>
            </li>
            <li><a class="" href="http://www.spurlock.illinois.edu/education/index.php">PROGRAMS &amp; EVENTS </a>
                <ul>
                    <li><a class="" href="http://www.spurlock.illinois.edu/education/calendar/index.php">Calendar of
                            Events</a></li>
                    <li><a href="#" class="NOLINK">Tours and Programs Information
                        </a>
                        <ul>
                            <li><a class="" href="http://www.spurlock.illinois.edu/education/in-house/index.html">In-house
                                    Tours &amp; Programs</a></li>
                            <li><a class="" href="http://www.spurlock.illinois.edu/education/outreach/index.html">Outreach
                                    Programs</a></li>
                            <li><a class="" href="http://www.spurlock.illinois.edu/education/reserving/index.html">Reserving
                                    Programs &amp; Tours</a></li>
                        </ul>
                    </li>
                    <li><a href="http://www.spurlock.illinois.edu/education/res_center/index.html">Educational Resource
                            Center</a></li>
                    <li><a href="http://www.spurlock.illinois.edu/education/facilities_rental.html">Facilities
                            Rental</a></li>
                    <li><a href="http://www.spurlock.illinois.edu/education/inviteus.html">Invite Us to Your Next
                            Meeting</a></li>
                </ul>
            </li>
...
<div id="mainContent">
    ...
    <table title="This table shows artifact data from the database"
           summary="This table outlines information from out databases regarding the given artifact. The information is divided into four sections: Basic Information, Physical Analysis, Research Remarks, and Artifact History.">
        <tr>
...
<div id="footer">
    ...
    <div>
        <a href="http://www.spurlock.illinois.edu/index.html">Spurlock Museum</a> | 600 S. Gregory St. | Urbana,
        Illinois 61801 | (217) 333-2360<br>

        &copy;
        <script type="text/javascript">
            document.write("2001-" + (new Date).getFullYear());
        </script>
        University of Illinois Board of Trustees | <a href="http://illinois.edu">University of Illinois at
