...
<h1><a href="../collections/index.html">Collections</a></h1>&nbsp;&gt;
    ...
    <table title="This table shows artifact data from the database"
        ...
        <tr>
        <th id="ShareInfo" colspan="2"><h4>Share Your Knowledge</h4></th>        
        </tr>
        <tr>
        <td id="ShareInfo2" colspan="2">Share any information you might have about this object with the Museum.</td>
        </tr>
        </table>
        <div class="row">
        <div class="large-8 centered columns">
        <!--<div class="panel">-->
        	<table title="Share Your Knowledge">
        <form id="ShareInfoForm" action="" method="POST">
        	<fieldset>
    <legend>Share Your Knowledge</legend>
        <tr>
        	<td headers="ShareInfo" class="leftcol">First Name:</td>
        	<td class="rightcol">
        		<input type="text" name="ShareInfofirst_name" placeholder="your first name">
        	</td>
        </tr>
        <tr>
        	<td headers="ShareInfo" class="leftcol">Last Name:</td>
        	<td class="rightcol">
        		<input type="text" name="ShareInfolast_name" placeholder="your last name">
        	</td>
        </tr>
        <tr>
        	<td headers="ShareInfo" class="leftcol">E-mail:</td>
        	<td class="rightcol">
        		<input type="text" name="ShareInfoemailadress" placeholder="your e-mail">
        	</td>
        </tr>
        <tr>
        	<td headers="ShareInfo" class="leftcol">Artifact/Object:</td>
        	<td class="rightcol">
        		<input type="text" name="ShareInfoartifact" readonly="readonly" size="50" style="color:blue;" value="<?php echo $artifact->getName(); ?> (<?php echo $artifact->getAccessionNumber(); ?>)">
        	</td>
        </tr>
        <tr>
        	<td headers="ShareInfo" class="leftcol">Comments:</td>
        	<td class="rightcol" >
        		<!--<input id = "ShareInfocomments" type="textarea" name="ShareInfocomments" class="required error" />-->
        		<textarea name="ShareInfocomments" rows="5" cols="50">
				</textarea>
        	</td>
        </tr>
        <tr>
        	<td headers="ShareInfo" class="leftcol"><input id="submit" type="image" src="elements/hires.gif" value="submit">
		<input type="reset" value="Reset"></td>
        </tr>
        </fieldset>         
		</form>		
    <div id="sendingmessageajaxloader"></div>
    <div id="thanks" style="visibility:hidden;">Your message has been submitted.  Thank you for your contribution to the Museum.</div>
    </table>
    <!--</div>-->
    </div>
    </div>
   <!-- <div id="ShareInformation">
    	<br>
    	Share any additional information you might have about this object with the Museum.
    	<form action="MAILTO:enskat1@illinois.edu" method="post" enctype="text/plain">
		First Name:<br>
		<input type="text" name="ShareInfoFName" placeholder="your first name"><br><br>
		Last Name:<br>
		<input type="text" name="ShareInfoLName" placeholder="your last name"><br><br>
		E-mail:<br>
		<input type="text" name="ShareInfoMail" placeholder="your email"><br><br>
		Artifact/Object:<br>
		<input type="text" name="ShareInfoObject" readonly="readonly" size="50" style="color:blue;" value="<?php echo $artifact->getName(); ?> (<?php echo $artifact->getAccessionNumber(); ?>)"><br><br>
		Comment:<br>
		<input type="text" name="ShareInfoComment" placeholder="Your Comment" size="75" height="50px"><br><br>
...
<script type="text/javascript">
$("#ShareInfoForm").validate({
	e.preventDefault();
submitHandler: function(form) {

$('#sendingmessageajaxloader', form).html('<img alt="" src="elements/ajax-loader-horizontal-green.gif" /> Please Wait...');
e.preventDefault();
$.ajax({
type: "POST",
url: "PHPMailer/send_form_email.php",
data: $(form).serialize(),
timeout: 20000,
success: function(msg) { $(form).fadeOut((500, function(){ $(form).html("
...
$("#ShareInfoForm").submit(); //Submit  the FORM
</script>
