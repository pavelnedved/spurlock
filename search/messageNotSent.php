    ...
    <div class="row">
    	<div class="panel secondary large-9 small-9 small-centered columns large-centered">
    		<div class="row">
    			...
    			Message Not Sent.<br><br>
    			Please verify that a valid email address is given and that all fields are filled. 	
    			</div>
    			<div class="small-2 columns">
    				<?php 
					$url = htmlspecialchars($_SERVER['HTTP_REFERER']);
  					echo "<a class='small alert button' href='$url'>Go Back</a>"; 
					?>
    			</div>    			
    		</div>
